...
title: 'I love the old man minimap in VS Code'
url: /blog/35/
---
...
![Sublime Minimap](/img/posts/35/sublime-minimap.png)
...
![VS Code Minimap](/img/posts/35/vs-code-minimap.png)
...
### Sublime's minimap
![Sublime pointed to the same spot of code](/img/posts/35/sublime-minimap-comparison.png)

### VS Codes minimap
![VS Code pointed to the same spot of code](/img/posts/35/vs-code-minimap-comparison.png)
